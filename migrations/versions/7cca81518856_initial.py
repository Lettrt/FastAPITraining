...
Revision ID: 7cca81518856
Revises: 
Create Date: 2023-10-22 13:10:42.653006
...
def downgrade() -> None:
    ...
    sa.Column('registrated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
